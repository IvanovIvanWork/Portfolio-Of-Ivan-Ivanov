...
3. "InfiniteRule" - (Проект в разработке) Бесконечная линейка. Данная программа есть здесь только для ознакомления с моими навыками OpenGL. Исходный код закрытый.

4. "Linesenil" - Клон игры Линии 1998 года, воссозданный через OpenGL и WinAPI на языке C++, в дальнейшем есть планы создать разные итерации этой игры. Исходный код закрытый.
